-- ============================================
-- CORREÇÃO: Garantir que times deletados sumam do Discovery
-- ============================================

-- Atualizar a função de deletar usuário (God Admin) para marcar time como inativo
-- antes de deletar, ou deletar completamente
...
-- ============================================
-- FUNÇÃO: Time se auto-excluir (corrigida)
-- ============================================
