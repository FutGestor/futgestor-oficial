-- ============================================
-- CORREÇÃO: admin_delete_user - remover tabela inexistente
-- ============================================
...
BEGIN
    ...
    IF _target_email = 'futgestor@gmail.com' THEN
        RAISE EXCEPTION 'Nao e permitido deletar a conta God Admin';
    END IF;
    ...
    -- 3. REMOVIDO: jogador_estatisticas (tabela nao existe)
    ...
    -- 11. SE O TIME SO TINHA ESTE USUARIO, DELETAR O TIME COMPLETAMENTE
...
-- Atualizar tambem a funcao delete_own_team para garantir consistencia
...
BEGIN
    ...
    -- REMOVIDO: jogador_estatisticas (tabela nao existe)
