-- ============================================
-- DIAGNÓSTICO E CORREÇÃO DAS NOTIFICAÇÕES
-- ============================================
...
-- ============================================
-- 2. RECRIAR O TRIGGER DE NOTIFICAÇÃO
-- ============================================
...
-- 
-- SELECT j.id, j.nome, j.email, j.user_id
-- FROM jogadores j
-- WHERE j.team_id = 'SEU_TEAM_ID_AQUI'
-- AND j.ativo = true;
--
...
-- ============================================
-- 4. RLS PARA NOTIFICAÇÕES (se não existir)
-- ============================================
...
CREATE POLICY "Usuários inserem suas próprias notificações" 
