  ...
  return (
    <Card className="border-2 border-secondary bg-card">
      ...
      <CardContent>
        ...
        {/* Confirmação de presença - apenas para jogadores logados e aprovados */}
...
function LastResultCard() {
  ...
  const resultadoColor = isVitoria
    ? "text-green-600"
    : isDerrota
    ? "text-destructive"
    : "text-muted-foreground";
  const bgColor = isVitoria
  ...
  return (
    <Card className="bg-card">
      ...
      <CardContent>
        ...
        <Link to="/resultados" className="mt-4 block">
  ...
  return (
    <Card className="bg-card">
      ...
      <CardContent>
        ...
        <Link to="/financeiro" className="mt-4 block">
          <Button variant="outline" className="w-full">
            Ver detalhes
            <ChevronRight className="ml-2 h-4 w-4" />
          </Button>
  ...
  return (
    <Card className="bg-card">
      ...
      <CardContent>
            ...
            {avisos.map((aviso) => (
              ...
              >
                <div className="mb-1 flex items-center gap-2">
                  <Badge
                    variant={aviso.categoria === "urgente" ? "destructive" : "secondary"}
                  >
        ...
        <Link to="/avisos" className="mt-4 block">
          <Button variant="outline" className="w-full">
            Ver todos
            <ChevronRight className="ml-2 h-4 w-4" />
          </Button>
  ...
  return (
    <Card className="bg-card">
      ...
      <CardContent>
        {escalacao && escalacao.jogo ? (
          <div>
            ...
            {jogadores && jogadores.length > 0 && (
              <p className="mt-1 text-sm text-muted-foreground">
                {jogadores.length} jogadores escalados
              </p>
            )}
          </div>
        ) : (
        ...
        <Link to="/escalacao" className="mt-4 block">
          <Button variant="outline" className="w-full">
            Ver escalação
            <ChevronRight className="ml-2 h-4 w-4" />
          </Button>
